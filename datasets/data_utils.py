...
from .celeba_dataset import get_celeba_dataset, get_ladn_dataset
...
def get_dataset(dataset_type, dataset_paths, config):
    ...
    elif dataset_type == "LADN":
        train_dataset, test_dataset = get_ladn_dataset(dataset_paths['LADN'], config)
    else:
        raise ValueError    
