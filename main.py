...
def parse_args_and_config():
    ...
    parser.add_argument('--MT_1_dir_loss_w', type=float, default=0.3, help='Weights of makeup direction loss in MT stage 1')
    parser.add_argument('--MT_2_dir_loss_w', type=float, default=0.5, help='Weights of makeup direction loss in MT stage 2')
    parser.add_argument('--MT_1_dis_loss_w', type=int, default=1, help='Weights of makeup distance loss')
    parser.add_argument('--MT_2_dis_loss_w', type=float, default=1.6, help='Weights of makeup distance loss')
    ...
    os.makedirs('sample_real_mr_train', exist_ok=True)
    os.makedirs('sample_fake_mr_train', exist_ok=True)
    os.makedirs('sample_real_mr_test', exist_ok=True)
    os.makedirs('sample_fake_mr_test', exist_ok=True)
    ...
    os.makedirs('sample_fake_removed_DiffAM', exist_ok=True)
